...
/**
 * Created by elemenzhang on 2017/6/14.
 */

public final class SortedContact {
    private Long id;
    ...
    SortedContact addDisplayName(String displayName) {
        this.displayName = displayName;
        return this;
    }

    SortedContact addGivenName(String givenName) {
        this.givenName = givenName;
        return this;
    }

    SortedContact addFamilyName(String familyName) {
        this.familyName = familyName;
        return this;
    }

    SortedContact addPhoneNumber(PhoneNumber phoneNumber) {
        phoneNumbers.add(phoneNumber);
        return this;
    }

    SortedContact addPhotoUri(String photoUri) {
        this.photoUri = photoUri;
        return this;
    }

    SortedContact addEmail(Email email) {
        emails.add(email);
        return this;
    }

    SortedContact addEvent(Event event) {
        events.add(event);
        return this;
    }

    SortedContact addCompanyName(String companyName) {
        this.companyName = companyName;
        return this;
    }

    SortedContact addCompanyTitle(String companyTitle) {
        this.companyTitle = companyTitle;
        return this;
    }

    SortedContact addWebsite(String website) {
        websites.add(website);
        return this;
    }

    SortedContact addNote(String note) {
        this.note = note;
        return this;
    }

    SortedContact addAddress(Address address) {
